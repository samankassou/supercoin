...
Frequently Asked <strong>Questions</strong></h1>
      </div>
    </div>
      </div>
</div>
...
<div class="inside_wrap faq">
  <div class="content">
        ...
        <h4 class="panel-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne">Is supercoin-trade a registered company?</a> </h4>
        </div>
        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
        <div class="panel-body">Yes, supercoin-trade is registered in the UK  as &quot;supercoin-trade".</div>
        </div>
        </div>
        <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingTwo">
        <h4 class="panel-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">How does supercoin-trade earn profits for its members?</a> </h4>
        </div>
        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
        <div class="panel-body">supercoin-trade  is involved in cloud mining, which enables our company to earn Bitcoins without mining hardware, software, electricity, or bandwidth.</div>
        </div>
        </div>
        <div class="panel panel-default">
        ...
        <div class="panel-body"> The minimum deposit amount is $20, the maximum you can deposit at one time is $100,000 Per each deposit , Surely you can make deposit higher than $100,000 by several deposits.</div>
        </div>
        </div>
        <div class="panel panel-default">
        ...
        <div class="panel-body"> The minimum withdrawal is $25. There is no maximum limit for withdrawal.</div>
        </div>
        </div>
        <div class="panel panel-default">
        ...
        <div class="panel-body"> You can request a withdrawal by clicking the &ldquo;Withdraw&rdquo; button in the member's area and entering the amount you want to withdraw.</div>
        </div>
        </div>
        <div class="panel panel-default">
...
<div class="panel panel-default">
        ...
        <div class="panel-body"> You can change your payment withdrawal address by clicking the &ldquo;Settings&rdquo; button on the menu after logging in to your account. Enter your new payment address and save the changes.</div>
        </div>
        </div>
        ...
        <div class="panel-body"> You can see your upline by clicking on &ldquo;Referrals&rdquo;, and you will see the username of your upline. If there is no username there, it means you have no upline.</div>
        </div>
        </div>
        <div class="panel panel-default two">
        ...
        <div class="panel-body"> Yes, you can register multiple accounts from the same computer or IP address .</div>
        </div>
        </div>
        <div class="panel panel-default two">
        ...
        <div class="panel-body"> You can contact our support through clicking the &ldquo;Contact Us&rdquo; link. We offer support through Contact Form, and E-mail.</div>
        </div>
        </div>
    </div>
	</div>
...
<!-- Mirrored from supercoin-trade.com/?a=faq by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 Oct 2020 15:22:18 GMT -->
</html>