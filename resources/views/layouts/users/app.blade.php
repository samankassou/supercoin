...
<head>
  ...
  <title>Supercoin | {{ auth()->user()->name }}</title>

  <!-- Google Font: Source Sans Pro -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
  <!-- Font Awesome Icons -->
  <link rel="stylesheet" href="{{ asset('templates/dashboard/plugins/fontawesome-free/css/all.min.css') }}">
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ asset('templates/dashboard/dist/css/adminlte.min.css') }}">
</head>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('templates/dashboard/dist/img/user2-160x160.jpg') }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('users.deposits') }}" class="nav-link {{ Request::routeIs('users.deposits') ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{ route('users.withdrawals') }}" class="nav-link {{ Request::routeIs('users.withdrawals') ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{ route('users.transactions') }}" class="nav-link {{ Request::routeIs('users.transactions') ? 'active' : '' }}">
...
<!-- jQuery -->
<script src="{{ asset('templates/dashboard/plugins/jquery/jquery.min.js') }}"></script>
<!-- Bootstrap 4 -->
